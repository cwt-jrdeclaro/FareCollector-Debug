...
{
    class FareCollectorFailedMessageLogManager : LoggingManager.FailedMessageLogManager
    {

        public FareCollectorFailedMessageLogManager(Utility.Environment appEnv, Utility.ClientBase clientBse)
